---
path: '/materials/uniforms'
type: 'GitHub'
img: './screenshot.png'
material:
  title: 'uniforms'
  url: 'https://github.com/vazco/uniforms'
  github_url: 'https://github.com/vazco/uniforms'
  subscribers_count: '32'
  stargazers_count: '631'
  tags: ['component-library','components','form-builder','form-controls','forms','meteor','react','react-components','react-library']
  subtitle: 'Bunch of React components and helpers to easily generate and validate forms.'
  clone_url: 'https://github.com/vazco/uniforms.git'
  ssh_url: 'git@github.com:vazco/uniforms.git'
  pushed_at: '2019-02-10T19:31:18Z'
  updated_at: '2019-02-06T09:24:44Z'
  author:
    name: 'vazco'
    avatar: 'https://avatars1.githubusercontent.com/u/1339616?v=4'
    github_url: 'https://github.com/vazco'
  latestRelease:
    tag_name: null
    name: null
    url: null
