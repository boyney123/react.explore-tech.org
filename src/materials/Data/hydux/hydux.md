---
path: '/materials/hydux'
type: 'GitHub'
img: './screenshot.png'
material:
  title: 'hydux'
  url: 'https://github.com/hydux/hydux'
  github_url: 'https://github.com/hydux/hydux'
  subscribers_count: '4'
  stargazers_count: '155'
  tags: ['2kb','elm-architecture','framework','hydux','hyperapp','preact','react','router','state-management','type-safe','typescript','virtual-dom']
  subtitle: 'A light-weight type-safe Elm-like alternative for Redux ecosystem, inspired by hyperapp and Elmish'
  clone_url: 'https://github.com/hydux/hydux.git'
  ssh_url: 'git@github.com:hydux/hydux.git'
  pushed_at: '2019-02-01T06:13:06Z'
  updated_at: '2019-02-01T06:13:08Z'
  author:
    name: 'hydux'
    avatar: 'https://avatars2.githubusercontent.com/u/34324699?v=4'
    github_url: 'https://github.com/hydux'
  latestRelease:
    tag_name: null
    name: null
    url: null
