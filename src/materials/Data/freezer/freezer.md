---
path: '/materials/freezer'
type: 'GitHub'
img: './screenshot.png'
material:
  title: 'freezer'
  url: 'https://github.com/arqex/freezer'
  github_url: 'https://github.com/arqex/freezer'
  subscribers_count: '35'
  stargazers_count: '1228'
  tags: ['flux','freezerjs','immutable','react','redux','state-management','store']
  subtitle: 'A tree data structure that emits events on updates, even if the modification is triggered by one of the leaves, making it easier to think in a reactive way.'
  clone_url: 'https://github.com/arqex/freezer.git'
  ssh_url: 'git@github.com:arqex/freezer.git'
  pushed_at: '2018-08-02T17:35:07Z'
  updated_at: '2019-02-12T02:44:08Z'
  author:
    name: 'arqex'
    avatar: 'https://avatars2.githubusercontent.com/u/6509397?v=4'
    github_url: 'https://github.com/arqex'
  latestRelease:
    tag_name: 'v0.14.0'
    name: 'Version 0.14.0'
    url: 'https://github.com/arqex/freezer/releases/tag/v0.14.0'
    created_at: '2018-02-19T19:17:08Z'
---
# Freezer
