---
path: '/materials/express-react-views'
type: 'GitHub'
img: './screenshot.png'
material:
  title: 'express-react-views'
  url: 'https://github.com/reactjs/express-react-views'
  github_url: 'https://github.com/reactjs/express-react-views'
  subscribers_count: '70'
  stargazers_count: '2146'
  tags: ['']
  subtitle: 'This is an Express view engine which renders React components on server. It renders static markup and *does not* support mounting those views on the client.'
  clone_url: 'https://github.com/reactjs/express-react-views.git'
  ssh_url: 'git@github.com:reactjs/express-react-views.git'
  pushed_at: '2019-01-28T02:46:12Z'
  updated_at: '2019-02-11T07:04:05Z'
  author:
    name: 'reactjs'
