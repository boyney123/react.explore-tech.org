---
path: '/materials/react-rails'
type: 'GitHub'
img: './screenshot.png'
material:
  title: 'react-rails'
  url: 'https://github.com/reactjs/react-rails'
  github_url: 'https://github.com/reactjs/react-rails'
  subscribers_count: '122'
  stargazers_count: '5450'
  tags: ['jsx','rails','react','react-rails','ruby','sprockets','webpacker']
  subtitle: 'Integrate React.js with Rails views and controllers, the asset pipeline, or webpacker.'
  clone_url: 'https://github.com/reactjs/react-rails.git'
  ssh_url: 'git@github.com:reactjs/react-rails.git'
  pushed_at: '2019-02-02T12:15:18Z'
  updated_at: '2019-02-11T19:29:28Z'
  author:
    name: 'reactjs'
  ...
  latestRelease:
    tag_name: 'v2.4.5'
    name: '2.4.5'
    url: 'https://github.com/reactjs/react-rails/releases/tag/v2.4.5'
    created_at: '2018-07-15T09:55:19Z'
---
# React-Rails
