---
path: '/materials/next.js'
type: 'GitHub'
img: './screenshot.png'
material:
  title: 'next.js'
  url: 'https://nextjs.org'
  github_url: 'https://github.com/zeit/next.js'
  subscribers_count: '769'
  stargazers_count: '34371'
  tags: ['browser','components','nextjs','node','react','server-rendering','universal']
  subtitle: 'The React Framework'
  clone_url: 'https://github.com/zeit/next.js.git'
  ssh_url: 'git@github.com:zeit/next.js.git'
  pushed_at: '2019-02-08T15:04:52Z'
  updated_at: '2019-02-08T16:20:45Z'
  author:
    name: 'zeit'
    avatar: 'https://avatars0.githubusercontent.com/u/14985020?v=4'
    github_url: 'https://github.com/zeit'
  latestRelease:
    tag_name: '7.0.2'
    name: ''
    url: 'https://github.com/zeit/next.js/releases/tag/7.0.2'
    created_at: '2018-10-11T15:08:15Z'
---
