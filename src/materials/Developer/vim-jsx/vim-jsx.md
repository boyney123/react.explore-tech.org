---
path: '/materials/vim-jsx'
type: 'GitHub'
img: './screenshot.png'
material:
  title: 'vim-jsx'
  url: 'https://github.com/mxw/vim-jsx'
  github_url: 'https://github.com/mxw/vim-jsx'
  subscribers_count: '18'
  stargazers_count: '1406'
  tags: ['']
  subtitle: 'React JSX syntax highlighting and indenting for vim.'
  clone_url: 'https://github.com/mxw/vim-jsx.git'
  ssh_url: 'git@github.com:mxw/vim-jsx.git'
  pushed_at: '2019-02-08T21:49:12Z'
  updated_at: '2019-02-08T04:14:33Z'
  author:
    name: 'mxw'
    avatar: 'https://avatars2.githubusercontent.com/u/1013739?v=4'
    github_url: 'https://github.com/mxw'
  latestRelease:
    tag_name: null
    name: null
    url: null
