---
path: '/materials/create-react-library'
type: 'GitHub'
img: './screenshot.png'
material:
  title: 'create-react-library'
  url: 'https://github.com/transitive-bullshit/create-react-library'
  github_url: 'https://github.com/transitive-bullshit/create-react-library'
  subscribers_count: '25'
  stargazers_count: '2094'
  tags: ['babel','cli','component','create-react-app','library','preact','react','rollup']
  subtitle: '⚡CLI for easily creating reusable react libraries.'
  clone_url: 'https://github.com/transitive-bullshit/create-react-library.git'
  ssh_url: 'git@github.com:transitive-bullshit/create-react-library.git'
  pushed_at: '2019-02-12T16:48:51Z'
  updated_at: '2019-02-12T06:57:10Z'
  author:
    name: 'transitive-bullshit'
    avatar: 'https://avatars0.githubusercontent.com/u/552829?v=4'
    github_url: 'https://github.com/transitive-bullshit'
  latestRelease:
    tag_name: null
    name: null
    url: null
