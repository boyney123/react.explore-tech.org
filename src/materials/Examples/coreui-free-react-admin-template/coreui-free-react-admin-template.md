---
path: '/materials/coreui-free-react-admin-template'
type: 'GitHub'
img: './screenshot.png'
material:
  title: 'coreui-free-react-admin-template'
  url: 'http://coreui.io/react/'
  github_url: 'https://github.com/coreui/coreui-free-react-admin-template'
  subscribers_count: '101'
  stargazers_count: '1661'
  tags: ['admin','admin-dashboard','admin-panel','admin-template','bootstrap','bootstrap-4','bootstrap-theme','bootstrap4','css','dashboard','dashboard-templates','html5','react','react-app','reactjs','scss']
  subtitle: 'CoreUI React is free React admin template based on Bootstrap 4 '
  clone_url: 'https://github.com/coreui/coreui-free-react-admin-template.git'
  ssh_url: 'git@github.com:coreui/coreui-free-react-admin-template.git'
  pushed_at: '2019-01-19T08:43:25Z'
  updated_at: '2019-02-10T18:19:05Z'
  author:
    name: 'coreui'
    avatar: 'https://avatars1.githubusercontent.com/u/36859861?v=4'
    github_url: 'https://github.com/coreui'
  latestRelease:
    tag_name: 'v2.1.3'
    name: 'v2.1.3'
    url: 'https://github.com/coreui/coreui-free-react-admin-template/releases/tag/v2.1.3'
    created_at: '2019-01-08T15:14:39Z'
---
