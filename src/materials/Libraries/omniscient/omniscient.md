---
path: '/materials/omniscient'
type: 'GitHub'
img: './screenshot.png'
material:
  title: 'omniscient'
  url: 'http://omniscientjs.github.io/'
  github_url: 'https://github.com/omniscientjs/omniscient'
  subscribers_count: '37'
  stargazers_count: '1194'
  tags: ['']
  subtitle: 'A library providing an abstraction for React components that allows for fast top-down rendering embracing immutable data for js'
  clone_url: 'https://github.com/omniscientjs/omniscient.git'
  ssh_url: 'git@github.com:omniscientjs/omniscient.git'
  pushed_at: '2018-10-25T18:22:20Z'
  updated_at: '2019-01-17T00:34:46Z'
  author:
    name: 'omniscientjs'
  ...
  latestRelease:
    tag_name: 'v4.2.0'
    name: 'v4.2.0'
    url: 'https://github.com/omniscientjs/omniscient/releases/tag/v4.2.0'
    created_at: '2017-10-19T15:56:15Z'
---
