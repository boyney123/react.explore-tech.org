---
path: '/materials/create-react-app-typescript'
type: 'GitHub'
img: './screenshot.png'
material:
  title: 'create-react-app-typescript'
  url: 'https://github.com/wmonk/create-react-app-typescript'
  github_url: 'https://github.com/wmonk/create-react-app-typescript'
  subscribers_count: '83'
  stargazers_count: '3774'
  tags: ['create-react-app','frontend','react','typescript','webpack']
  subtitle: 'DEPRECATED: Create React apps using typescript with no build configuration.'
  clone_url: 'https://github.com/wmonk/create-react-app-typescript.git'
  ssh_url: 'git@github.com:wmonk/create-react-app-typescript.git'
  pushed_at: '2019-01-22T10:38:24Z'
  updated_at: '2019-02-09T19:23:11Z'
  author:
    name: 'wmonk'
    avatar: 'https://avatars0.githubusercontent.com/u/175278?v=4'
    github_url: 'https://github.com/wmonk'
  latestRelease:
    tag_name: 'v2.17.0'
    name: ''
    url: 'https://github.com/wmonk/create-react-app-typescript/releases/tag/v2.17.0'
    created_at: '2018-08-05T09:04:26Z'
---
### ⛔ DEPRECATED ⛔
