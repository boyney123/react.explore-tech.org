...
material:
  title: 'saas'
  url: 'https://saas-app.async-await.com'
  github_url: 'https://github.com/async-labs/saas'
  subscribers_count: '44'
  stargazers_count: '729'
  tags: ['aws-s3','aws-ses','boilerplate','express','google-api','mailchimp','material-ui','mobx','mongodb','mongoose','nextjs','passport','react','saas','typescript']
  subtitle: 'Build your own SaaS product with SaaS boilerplate app. Stack: React, Material-UI, Next, MobX, Express, Node, Mongoose, MongoDB. Written with TypeScript.'
  clone_url: 'https://github.com/async-labs/saas.git'
  ssh_url: 'git@github.com:async-labs/saas.git'
  pushed_at: '2019-02-04T18:44:17Z'
  updated_at: '2019-02-10T05:15:37Z'
  author:
    name: 'async-labs'
    avatar: 'https://avatars0.githubusercontent.com/u/37727559?v=4'
    github_url: 'https://github.com/async-labs'
  latestRelease:
    tag_name: 'v1.2.0'
    name: 'v1.2.0'
    url: 'https://github.com/async-labs/saas/releases/tag/v1.2.0'
    created_at: '2018-10-12T18:08:33Z'
---
