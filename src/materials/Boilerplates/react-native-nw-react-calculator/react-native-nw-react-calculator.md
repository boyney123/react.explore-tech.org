---
path: '/materials/react-native-nw-react-calculator'
type: 'GitHub'
img: './screenshot.png'
material:
  title: 'react-native-nw-react-calculator'
  url: 'https://github.com/benoitvallon/react-native-nw-react-calculator'
  github_url: 'https://github.com/benoitvallon/react-native-nw-react-calculator'
  subscribers_count: '178'
  stargazers_count: '4715'
  tags: ['android-app','architecture','desktop','electron','flux','ios-app','react','react-native','universal-app']
  subtitle: 'Mobile, desktop and website Apps with the same code'
  clone_url: 'https://github.com/benoitvallon/react-native-nw-react-calculator.git'
  ssh_url: 'git@github.com:benoitvallon/react-native-nw-react-calculator.git'
  pushed_at: '2018-02-13T15:01:46Z'
  updated_at: '2019-02-10T19:01:19Z'
  author:
    name: 'benoitvallon'
    avatar: 'https://avatars1.githubusercontent.com/u/2761144?v=4'
    github_url: 'https://github.com/benoitvallon'
  latestRelease:
    tag_name: null
    name: null
    url: null
