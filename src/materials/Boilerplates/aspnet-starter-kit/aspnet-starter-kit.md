---
path: '/materials/aspnet-starter-kit'
type: 'GitHub'
img: './screenshot.png'
material:
  title: 'aspnet-starter-kit'
  url: 'https://twitter.com/dotnetreact'
  github_url: 'https://github.com/kriasoft/aspnet-starter-kit'
  subscribers_count: '99'
  stargazers_count: '986'
  tags: ['']
  subtitle: 'Cross-platform web development with Visual Studio Code, C#, F#, JavaScript, ASP.NET Core, EF Core, React (ReactJS), Redux, Babel. Single-page application boilerplate.'
  clone_url: 'https://github.com/kriasoft/aspnet-starter-kit.git'
  ssh_url: 'git@github.com:kriasoft/aspnet-starter-kit.git'
  pushed_at: '2017-09-04T17:10:49Z'
  updated_at: '2019-02-08T17:08:53Z'
  author:
    name: 'kriasoft'
