---
path: '/materials/wp-reactjs-starter'
type: 'GitHub'
img: './screenshot.png'
material:
  title: 'wp-reactjs-starter'
  url: 'https://matthias-web.com'
  github_url: 'https://github.com/matzeeable/wp-reactjs-starter'
  subscribers_count: '3'
  stargazers_count: '12'
  tags: ['babel','boilerplate-plugin','jsx','mobx','mobx-react','mobx-state-tree','reactjs','sass','webpack','wordpress','wordpress-plugin']
  subtitle: ':star2: WordPress Plugin Boilerplate using new web technologies like ES6, SASS, and so on...'
  clone_url: 'https://github.com/matzeeable/wp-reactjs-starter.git'
  ssh_url: 'git@github.com:matzeeable/wp-reactjs-starter.git'
  pushed_at: '2018-12-29T20:40:13Z'
  updated_at: '2019-02-10T18:22:46Z'
  author:
    name: 'matzeeable'
    avatar: 'https://avatars3.githubusercontent.com/u/1008534?v=4'
    github_url: 'https://github.com/matzeeable'
  latestRelease:
    tag_name: null
    name: null
    url: null
