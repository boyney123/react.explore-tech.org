---
path: '/materials/rekit'
title: 'rekit'
url: 'http://rekit.js.org'
github_url: 'https://github.com/supnate/rekit'
author:
  name: 'supnate'
  avatar: 'https://avatars2.githubusercontent.com/u/481738?v=4'
  github_url: 'https://github.com/supnate'
subscribers_count: '145'
stargazers_count: '3682'
img: './screenshot.png'
tags: ['react','react-router','redux','rekit']
subtitle: 'IDE and toolkit for building scalable web applications with React, Redux and React-router'
latestRelease:
  tag_name: 'rs-2.4.0'
  name: 'Rekit Studio 2.4.0'
  url: 'https://github.com/supnate/rekit/releases/tag/rs-2.4.0'
  created_at: '2018-06-14T14:52:47Z'
---
