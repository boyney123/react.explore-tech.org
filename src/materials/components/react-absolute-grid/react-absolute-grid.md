---
path: '/materials/react-absolute-grid'
type: 'GitHub'
img: './screenshot.png'
material:
  title: 'react-absolute-grid'
  url: 'http://jrowny.github.io/react-absolute-grid/demo'
  github_url: 'https://github.com/jrowny/react-absolute-grid'
  subscribers_count: '29'
  stargazers_count: '840'
  tags: ['react','react-component','react-components','reactjs','reactjs-components']
  subtitle: 'An absolutely positioned, animated, filterable, sortable, drag and droppable, ES6 grid for React.'
  clone_url: 'https://github.com/jrowny/react-absolute-grid.git'
  ssh_url: 'git@github.com:jrowny/react-absolute-grid.git'
  pushed_at: '2018-04-01T14:55:42Z'
  updated_at: '2019-02-08T13:27:15Z'
  author:
    name: 'jrowny'
    avatar: 'https://avatars0.githubusercontent.com/u/367710?v=4'
    github_url: 'https://github.com/jrowny'
  latestRelease:
    tag_name: null
    name: null
    url: null
