---
path: '/materials/react-admin'
type: 'GitHub'
img: './screenshot.png'
material:
  title: 'react-admin'
  url: 'http://marmelab.com/react-admin'
  github_url: 'https://github.com/marmelab/react-admin'
  subscribers_count: '210'
  stargazers_count: '6771'
  tags: ['admin','admin-dashboard','admin-on-rest','frontend-framework','material-ui','react','react-admin','rest','single-page-app']
  subtitle: 'A frontend Framework for building admin applications running in the browser on top of REST/GraphQL APIs, using ES6, React and Material Design'
  clone_url: 'https://github.com/marmelab/react-admin.git'
  ssh_url: 'git@github.com:marmelab/react-admin.git'
  pushed_at: '2019-02-08T14:25:27Z'
  updated_at: '2019-02-08T13:30:42Z'
  author:
    name: 'marmelab'
    avatar: 'https://avatars1.githubusercontent.com/u/3116319?v=4'
    github_url: 'https://github.com/marmelab'
  latestRelease:
    tag_name: 'v2.7.0'
    name: '2.7.0'
    url: 'https://github.com/marmelab/react-admin/releases/tag/v2.7.0'
    created_at: '2019-02-04T14:21:16Z'
---
