---
path: '/materials/object-editor-react'
type: 'GitHub'
img: './screenshot.png'
material:
  title: 'object-editor-react'
  url: 'https://b-gran.github.io/object-editor-react/githubExample.html'
  github_url: 'https://github.com/b-gran/object-editor-react'
  subscribers_count: '6'
  stargazers_count: '40'
  tags: ['component','editor','json','objects','react','schema']
  subtitle: 'Schema-aware editor for structured JSON objects (drop-in React component)'
  clone_url: 'https://github.com/b-gran/object-editor-react.git'
  ssh_url: 'git@github.com:b-gran/object-editor-react.git'
  pushed_at: '2018-05-27T18:42:35Z'
  updated_at: '2019-01-19T22:02:41Z'
  author:
    name: 'b-gran'
    avatar: 'https://avatars1.githubusercontent.com/u/2000233?v=4'
    github_url: 'https://github.com/b-gran'
  latestRelease:
    tag_name: 'v1.0.2'
    name: 'v1.0.2'
    url: 'https://github.com/b-gran/object-editor-react/releases/tag/v1.0.2'
    created_at: '2018-04-08T16:22:54Z'
---
# `object-editor-react`
