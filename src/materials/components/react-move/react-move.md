---
path: '/materials/react-move'
type: 'GitHub'
img: './screenshot.png'
material:
  title: 'react-move'
  url: 'https://react-move.js.org'
  github_url: 'https://github.com/react-tools/react-move'
  subscribers_count: '64'
  stargazers_count: '5718'
  tags: ['animate','animation','easing','interpolation','motion','move','movement','react','transition-animation']
  subtitle: 'React Move 🌀 Beautiful, data-driven animations for React'
  clone_url: 'https://github.com/react-tools/react-move.git'
  ssh_url: 'git@github.com:react-tools/react-move.git'
  pushed_at: '2019-02-01T20:12:18Z'
  updated_at: '2019-02-12T13:13:56Z'
  author:
    name: 'react-tools'
    avatar: 'https://avatars2.githubusercontent.com/u/30272234?v=4'
    github_url: 'https://github.com/react-tools'
  latestRelease:
    tag_name: 'v5.1.0'
    name: 'Version 5.1.0'
    url: 'https://github.com/react-tools/react-move/releases/tag/v5.1.0'
    created_at: '2019-02-01T19:41:16Z'
---
